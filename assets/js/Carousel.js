...
function updateCarousel() {
  carousel.style.width = `${(cards.length * 100) / cardsToShow}%`;
  // Calculate the amount to translate the carousel
  const newTransform = -(currentIndex * ((100 * cardsToShow) / cards.length)); // Adjust the translation
