...
<body>
    <div class="grid dashboard-wrapper">
        ...
        $currentPage = 'Request History';  // set the current page for active link
        include('../includes/sidebar.php');
        ?>
        <main class="recipient-dashboard dashboard">
            <div class="container">
                <div class="request-history container flex-column">
                    <div class="heading">
                        <h2 class="heading-text text-center">Blood Request History</h2>
                    </div>
