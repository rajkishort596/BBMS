<div id="upcoming-campaign" class="tab-content flex-column">
    <h3 class="ff-Merriweather text-center">Upcoming Donation Campaign</h3>
    ...
    <div class="upcoming-campaign-container">
        <div class="campaign-carousel flex ">
            ...
            <!-- <div class="campaign-card card flex-column">
                ...
                <div class="Registered-donors flex-column">
    ...
    <div class="arrows flex w-100">
        <span class="arrow left-arrow">
            <svg width="36" height="22" viewBox="0 0 36 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10.7614 21.4205L0.159091 10.8182L10.7614 0.215908L12.8068 2.23864L5.70455 9.34091H35.9091V12.2955H5.70455L12.8068 19.3864L10.7614 21.4205Z" fill="#FF0000" />
            </svg>
        </span>
        <span class="arrow right-arrow">
            <svg width="36" height="22" viewBox="0 0 36 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25.2386 0.579549L35.8409 11.1818L25.2386 21.7841L23.1932 19.7614L30.2955 12.6591L0.0909127 12.6591V9.70455L30.2955 9.70455L23.1932 2.61364L25.2386 0.579549Z" fill="#FF0000" />
            </svg>
        </span>
    </div>
...
<div id="modalPopup" class="modal">
    ...
    <p id="modalMessage" class="text-center failure">Are You Sure You Want to Delete This Campaign?</p>
    <button class="Red-btn btn " id="confirm-btn">Yes</button>
</div>